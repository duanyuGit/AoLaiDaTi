...
public class FloatMonkService extends Service implements FloatCallBack {
    ...
    @Override public void setAnswers(String platFormChineseName, String sougo, String baidu, String uc) {
        FloatWindowManager.setAnswers(platFormChineseName,sougo,baidu,uc);
    }

    @Override
    public void setOnClickCloseListener(FloatLayout.OnClickCloseListener pOnClickCloseListener) {
        FloatWindowManager.setOnClickCloseListener(pOnClickCloseListener);
    }
}
