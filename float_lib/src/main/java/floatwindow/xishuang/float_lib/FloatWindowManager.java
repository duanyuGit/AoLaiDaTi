...
public class FloatWindowManager {
  ...
  public static void removeFloatWindowManager() {
    ...
    if (mHasShown && isAttach && mWindowManager != null) mWindowManager.removeView(mFloatLayout);
  }
   ...
   * 更新答案结果
   */
  public static void setAnswers(String platFormChineseName, String sougo, String baidu, String uc) {
    mFloatLayout.setAnswers(platFormChineseName,sougo, baidu, uc);
  }

  public static void setOnClickCloseListener(FloatLayout.OnClickCloseListener pOnClickCloseListener) {
    mFloatLayout.setOnClickCloseListener(pOnClickCloseListener);
  }
}
